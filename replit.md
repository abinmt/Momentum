...
- ✅ **Dark Theme Consistency Fix (Aug 12)**: Fixed all dark theme inconsistencies including profile dropdown backgrounds, PWA settings components, toggle switches, and badge colors - changed primary color from orange to neutral blue-gray, updated Switch component for translucent styling, and enhanced Badge variants with proper dark mode colors
