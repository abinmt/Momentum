    ...
    return (
        <>
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="bg-dark text-white border-gray-700 max-w-md mx-auto bottom-0 top-auto translate-y-0 rounded-t-3xl rounded-b-none">
                    ...
                    <ScrollArea className="max-h-96">
                        <div className="space-y-3">
                            {HEALTH_TASKS.map((task) => (
                                <div 
                                    key={task.id}
                                    className="flex items-center justify-between py-3 border-b border-gray-700 cursor-pointer hover:bg-gray-800 rounded px-2"
